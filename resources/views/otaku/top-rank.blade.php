         ...
         success: function(data){
          ...
          if (data['top'].length > 0) {
            for (var i = 0; i < data['top'].length; i++) {
                ...
                content += '<a href="{{ url('detail') }}/'+type+'/'+data['top'][i]['mal_id']+'" itemprop="contentUrl" data-size="600x446">'
                content += '<img class="gallery-thumbnail card-img-top" src="'+data['top'][i]['image_url']+'" itemprop="thumbnail" alt="'+data['top'][i]['title']+'" />'
                content += '</a>'
                content += '<div class="card-body px-0">'
                content += '<h4 class="card-title">'+data['top'][i]['title']+' ['+data['top'][i]['score']
                content += ']</h4>'
                content += '</div>'
                content += '</figure>'
                content += '</div>\n'
    ...
    <div class="content-body">
        <section id="search-results" class="row overflow-hidden ml-4 mr-0 mt-0">
            <div class="col-lg-6 col-md-12 col-sm-12 col-12 ">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title text-center">Top 50 Anime</h4>
            ...
            <div class="col-lg-6 col-md-12 col-sm-12 col-12 ">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title text-center">Top 50 Manga</h4>
